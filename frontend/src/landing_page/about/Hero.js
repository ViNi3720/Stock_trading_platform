    ...
    <div className="container">
      <div className="row p-5 mt-5 mb-5">
        <h1 className="fs-2 text-center">
          ...
          Now, We are breaking ground with our tchnology.
        </h1>
      </div>
      <div
      ...
      >
        <div className="col p-5">
          ...
          <p>
            ...
            <br /> technology have made us the biggest stock broker in <br />{" "}
            India.
          </p>
          <p>
        ...
        <div className="col p-5">
          ...
          <p>
            ...
            Catch up on the latest updates on our blog or see what <br /> the
            media is saying about us or learn more about our
